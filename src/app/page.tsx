...
export default async function Home({
  ...
  return (
    <main className="flex flex-col items-center">
      {/* hero section  */}
      <div className="flex  lg:flex-row items-center justify-center flex-col-reverse my-3 py-4 lg:py-8">
        <div className="w-[80%] lg:w-[60%] flex flex-col gap-y-4">
          <h2 className="font-bold text-5xl lg:text-[3.875rem]">
            ...
            <form action={searchProducts}>
              <div className="flex w-full ">
                <input
                  ...
                  className="outline-none border-2 p-3 border-r-0 w-[60%] rounded-l-lg "
                />
                <button
                  type="submit"
      ...
      {/* value section start  */}
      <div className="bg-[#f5f5f5] my-6 px-4 py-7">
